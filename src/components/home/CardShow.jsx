    ...
    <div className="w-full">
      <div className="grid grid-cols-1 md:grid-cols-2">
        {cards.map((card, index) => (
          <div key={index} className="relative w-full aspect-3/4 lg:aspect-auto lg:min-h-[500px] overflow-hidden group">
            {/* Image */}
            <img 
              src={card.image} 
              alt={card.title}
            ...
            {/* Top-right text - Vertical */}
            <div className="absolute top-4 right-4">
              <p className="text-sm font-medium text-white [writing-mode:vertical-rl]">
                Brandon McKoy Jr.
              </p>
            </div>
